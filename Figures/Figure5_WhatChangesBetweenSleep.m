...
% h = plotMultiStrip(binsizes,Ddatashuf.Learn,[6 4],colours.learning,widths,fontsize,fontname,'Word binsize (ms)',...
%                 'Difference (Data - Shuffle)',xtickSmall,strXlabelSmall,[xmin xmax],[-0.1 0.1],M);
% line([eps xmax],[0 0],'Color',colours.shuf.line,'Linewidth',widths.axis); hold on
% print([exportpath 'Fig6_Learn_Sleep_DatavsShuf'],'-dsvg');     
%                     
% h = plotMultiStrip(binsizes,Ddatashuf.Stable,[6 4],colours.stable,widths,fontsize,fontname,'Word binsize (ms)',...
%                 'Difference (Data - Shuffle)',xtickSmall,strXlabelSmall,[xmin xmax],[-0.1 0.1],M);
% line([eps xmax],[0 0],'Color',colours.shuf.line,'Linewidth',widths.axis); hold on
% print([exportpath 'Fig6_Stable_Sleep_DatavsShuf'],'-dsvg');     
